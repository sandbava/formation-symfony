 ...
 * @UniqueEntity(
 *     fields={"title"},
 *     message="Une autre image possède déjà ce titre, merci de le modifier"
 * )
 */
class Ad
{
     ...
     *     minMessage="Le texte doit faire plus de 10 caractères",
     *     maxMessage="Le texte ne peut pas dépasser 255 caractères")
     */
    private $title;
    ...
    /**
     * Cette fonction permet d'avoir un tableau des jours indisponibles pour cette annonce
     *
